...
def get_data():
    ...
    X, Y = np.meshgrid(np.linspace(0, 2, 500), np.linspace(0, 2, 500))
...
if __name__ == "__main__":
    ...
    rect = get_rect(x=120, y=80, width=100, height=40, angle=0)
    draw.polygon([tuple(p) for p in rect], fill="rgb(255,255,0)")
